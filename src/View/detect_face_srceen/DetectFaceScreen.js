...
export default class DetectScreen extends React.Component {
  ...
  renderFrame = () => (
    <View style={styles.captureBox}>
      ...
      <Text style={{ color: 'white', textAlign: 'center' }}>Please center your face to the frame</Text>
            ...
            {this.state.base64ImageData === "" ? (
              <View style={styles.captureBox}>
                ...
                <View >
                  ...
                  />
                  <Text style={styles.description}>Please make sure that your face look clear and not being crop</Text>
